...
contract L5 is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    ...
    uint8 private maxTaxFee = 10;
    uint8 private maxBurnFee = 10;
    uint8 private maxWalletFee = 10;
    ...
    // 100 Billion L5
    uint256 public _tTotal = 1 * 10**2 * 10**9 * 10**18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    
    string public _name = "L5";
    string public _symbol = "L5";
    ...
    address payable public feeWallet = payable(0x8190b3673E15490F7929b63B21e9139206A6D9B0);
